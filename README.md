...
The Favero Full Arm scoring machines use serial data output that can be interpreted through an Arduino and then relayed to Open Broadcast Software (OBS), here is an [example on Youtube](https://youtu.be/noGRDSjEuyg?t=1262), where the data is overlayed onto a live stream of the fencing.
